...
import {FireEscaper, Direction, NextPosition} from "./fire_escaper"
...
function main() {
    ...
    let directionOrder: Direction[] = [Direction.Left, Direction.Up, Direction.Down, Direction.Right]
    // efficient ordering
    ...
    escaper.recursionSolver(entrance, new NextPosition(entrance.row, entrance.col, MapSymbols.Cursor))
}
